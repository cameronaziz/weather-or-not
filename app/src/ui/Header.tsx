...
const Title: FC = () => {
  ...
  return (
    <div className='text-center'>
      ...
      <p className={clsx('mt-3 transition-colors duration-200 ease-in-out', {
...
const Header: FC = () => {
  ...
  return (
    <div className={clsx('fixed left-0 right-0 z-10 px-[20vw] py-6 transition-top duration-500 ease-in-out', {
      'top-[30vh]': !hasMessages,
      'top-[10vh]': hasMessages
    })}>
